...
class AppTextStyles {
  ...
  static TextStyle pendingMessage(BuildContext context) => subtitle(context);
  static TextStyle bodyBook(BuildContext context) => body(context);
  static TextStyle uploadHint(BuildContext context) => inputHint(context);
  static TextStyle uploadAction(BuildContext context) => textLink(context);
}
